    ...
    namespace BankTransactionManagement
{
        ...
        public WebAPIResponse CallGenericGetWithBearerTokenAuthentication(RequestTypeAction RequestType, string GatewayEndpoint, Dictionary<string, string> HeaderDictionary, String Token)
        {
        ...
        private static async Task<WebAPIResponse> callGenericGetWithBearerTokenAuthentication(RequestTypeAction RequestType, string GatewayEndpoint, Dictionary<string, string> HeaderDictionary, String Token)
        {
            try
            {
                Uri uri = new Uri(GatewayEndpoint);
